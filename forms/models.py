...
class Household(models.Model):
    ...
    name = models.CharField(max_length=50, unique=True, help_text='Enter a name for the household.')
...
class Person(models.Model):
    ...
    full_name = models.CharField(max_length=240, unique=True)  # full name, formatted like so {{Surname} {Extension}, {First Name} {Middle Name}}
    last_name = models.CharField(max_length=128, help_text='Enter surname here.')  # surname
    first_name = models.CharField(max_length=128, help_text='Enter first name here.')  # first name
    middle_name = models.CharField(max_length=64, blank=True, help_text='Enter middle name here, if needed.')  # middle name
    ...
    occupation = models.CharField(max_length=100, help_text='Enter occupation here.')  # job
    author = models.ForeignKey(User, on_delete=models.PROTECT, null=True)
